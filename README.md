...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/intake-esgf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/intake-esgf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add intake-esgf
# for installing globally
pixi global install intake-esgf
```
...
It is possible to list all of the versions of `intake-esgf` available on your platform:
...
```
pixi search intake-esgf --channel conda-forge
```
